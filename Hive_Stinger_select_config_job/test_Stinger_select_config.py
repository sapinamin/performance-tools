...
#orig_queries_dir = os.path.join(curr_script_dir + "/test_queries_testing_set")
...
print "All init.sql are located under " + init_sql_dir
...
def get_time_failures(stdoutline, all_rounds_list, failure_rounds_list, query_name):
	...
	if "FAILED:" in stdoutline:		
			failure_rounds_list[1] = stdoutline
