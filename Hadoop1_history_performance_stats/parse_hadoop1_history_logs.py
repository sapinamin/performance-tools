...
class Hadoop1PerfCounters:
	...
	def calculate_job_readings(cls, job_readings, job_graph_readings_list):
		...
		try:
			...
			print(" Occured during ELAPSED_TIME, avg map AVG_MAP_TIME or avg AVG_REDUCE_TIME calculation : " , e)
	...
	def get_total_maps(cls, basic_job_list):
		...
		try:
			...
			print ("Problem in finding total Maps : " + str(e))
	...
	def get_total_reduces(cls, basic_job_list):
		...
		try:
			...
			print ("Problem in finding total Reduces : " + str(e))
	...
	def readPerfCountersFromConf(cls, conf_file_path):		
		...
		try:
			...
			print("There was an error in reading the conf file : " + str(e))				            


Hadoop1 = Hadoop1PerfCounters()
if len(sys.argv) < 3:
  print("Please enter the path where Hadoop1 history logs are located ...Exiting System")
  sys.exit(0)
else:
  hadoop1_history_logs_path = sys.argv[1]
  hadoop1_perf_conf_path = sys.argv[2]
  Hadoop1.getPerfCountersAndReport(hadoop1_history_logs_path, hadoop1_perf_conf_path)
	
#Hadoop1.getPerfCountersAndReport("/Users/samin/history_logs/Tera_logs_flubber/done", "/Users/samin/history_logs/final_scripts/")
#Hadoop1.getPerfCountersAndReport("/Users/samin/history_logs/final_scripts/Hadoop1_history_performance_stats/history_logs/","/Users/samin/history_logs/final_scripts/Hadoop1_history_performance_stats/hadoop1_perf_counters.conf")
